...
$('.next-button').on('click', () => {
    window.location.href = './combatEN.html';
});
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (showPopup) {
        Swal.fire({
            title: 'Distribution',
            html: 'You need to allocate 15 fighters to the 5 combat zones and choose 5 reservists who will not fight right away but can be deployed later. Fighters can be dragged-dropped into the desired zone.',
            icon: 'info',
